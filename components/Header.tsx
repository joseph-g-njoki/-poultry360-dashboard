        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search farms, batches, records..."
            />
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="relative p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 rounded-lg transition-colors">
            <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5-5 5-5m-5 5H9a2 2 0 01-2-2V5a2 2 0 012-2h6a2 2 0 012 2v5a2 2 0 01-2 2z" />
            </svg>
            {/* Notification badge */}
